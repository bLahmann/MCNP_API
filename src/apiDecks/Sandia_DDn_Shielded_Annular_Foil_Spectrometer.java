...
public class Sandia_DDn_Shielded_Annular_Foil_Spectrometer extends MCNP_Deck{
    ...
    private Double blastShieldThickness = 0.635;            // Blast Shield Thickness (cm)

    private Double shieldingThickness   = 10.0;             // Thickness of the shielding plug (cm)
    ...
    private Double chFoilThickness = 10.0 * 1e-4;           // Thickness of the CH foil (cm)
    ...
    private MCNP_Material blastShieldMaterial   = MCNP_Material.aluminum("70c");
        ...
        for (double shieldThickness : shieldThicknesses) {
            for (double chThickness : cHThicknesses) {
                for (double separation : separations) {
                    ...
                    spectrometer.shieldMaterial = null;
    ...
    public void buildDeck() throws Exception{
        ...
        this.addParameter("Blast Shield Thickness (cm)", blastShieldThickness);
        this.addParameter("", "");
        ...
        totalDistance += blastShieldThickness;
        ...
        MCNP_Cell firstBlastShield = new MCNP_Cell("First Blast Shield", blastShieldMaterial, 1);
        ...
        MCNP_Cell secondBlastShield = new MCNP_Cell("Second Blast Shield", blastShieldMaterial, 1);
